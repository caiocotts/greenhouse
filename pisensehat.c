...
/** @brief Closes Down the Sensehat
 *  @author Paul Moggach
 *  @author Kristian Medri
 *  @version 2020-05-01
 *  @param void
...
/** @brief Clears Sensehat 8X8 RGB LED display
 *  @author Paul Moggach
 *  @author Kristian Medri
 *  @version 2020-05-03
 *  @param void
...
/** @brief Sets a pixel on the Sensehat display
 *  @author Paul Moggach
 *  @author Kristian Medri
 *  @version 2020-05-01
...
/** @brief Gets HT221S Sensehat sensor data
 *  @author Paul Moggach
 *  @author Kristian Medri
 *  @version 2020-05-03
 *  @param void
